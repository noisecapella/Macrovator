...
popup_search = () ->
        ...
        if result
                ...
                action_type_obj = {"type" : "SearchActionType"}
                search_action_type_obj = {"search_key" : result}
                $.post(url, {"action_type": action_type_obj, "search_action_type": search_action_type_obj}, (data) ->
                        update_content(data))
